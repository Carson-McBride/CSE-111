...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for x in symbol_quantity_list:
        ...
        global quantity_of_atoms
        quantity_of_atoms = None 
        quantity_of_atoms = x[QUANTITY_INDEX]
        if symbol in periodic_table_dict:
            global element
            element = periodic_table_dict[symbol]
            global atomic_mass
            atomic_mass = element[ATOMIC_MASS_INDEX]
        mass_increase = atomic_mass * quantity_of_atoms
        total_mass += (mass_increase)     
